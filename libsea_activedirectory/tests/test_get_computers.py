...
"""Test ActiveDirectory API- Get Computers: Jerod Gawne, 2019.04.03 <https://github.com/jerodg/>"""
import asyncio
import logging
import sys
import time
...
with ActiveDirectoryApi(ROOT, SEM) as adapi:
    def test_get_computers():
        ...
        results = loop.run_until_complete(adapi.get_computers())
        ...
        print(format_banner(f'Test: Get Computers'))
